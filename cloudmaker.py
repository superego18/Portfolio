...
wordcloud = WordCloud(font_path=font_path,  background_color="black", colormap='Greens', width = 700, height = 700, random_state = 43, max_font_size=150, min_font_size=5, max_words=5000, mask=mask).generate_from_frequencies(word_counts)
